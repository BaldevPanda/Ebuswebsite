...
$scsql="UPDATE booking set transactionresult='success' WHERE transactionid='$trid'";
if($conn->query($scsql))
{
	...
	<div class="container">
		...
		<div class="container-fluid">
			<div class="panel panel-primary">
		      <div class="panel-heading" style="background-color: #00b33c;"><h3>Booking Successful</h3></div>
		      <div class="panel-body">
		      	<div class="container-fluid">
		      		<div class="col-sm-4">
		      			<div class="row">
							<p class='text'><bold>Bus Name : </bold>
								<?php 
									$bid=$_SESSION['busid'];
									$sql="SELECT busname FROM bus_info WHERE bid='$bid'";
						...
						<div class="row">
							<p class='text'><bold>Destination :</bold> <?php echo $_SESSION['to']; ?></p>
						</div>
						<div class="row">
							<p class='text'><bold>Leaving From :</bold> <?php echo $_SESSION['from']; ?></p>
						</div>
						<div class="row">
							<p class='text'><bold>Date of Journey :</bold> <?php echo $_SESSION['date']; ?></bold></p>
						</div>
						<div class="row">
							<p class='text'><bold>Tranasaction I.D. :</bold> <?php echo $_SESSION['trans_id']; ?></p>
						</div>
						<div class="row">
							<p class='text'><bold>Seat Number :</bold> <?php echo $_SESSION['seat']; ?></p>
						</div>
						<div class="row">
							<p class='text'><bold>Amount :</bold> <?php echo $_SESSION['amount']; ?></p>
						</div>
		      		</div>
		      		<div class="col-sm-8">
		      	...
		      	<div class="panel-footer">
		      		<p style="color:green;  font-size: 120%;">* Your Ticket will be sent to your Email I.D. and your mobile number</p>
		      	</div>
		      </div>
		    </div>
		</div>

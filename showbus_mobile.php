					...
					while($routerow=mysqli_fetch_assoc($routeresult))
					{
						...
						if($seatcheckresult->num_rows>0)
						{
							...
							if($seatcheckrow['seatsleft']>0)
							{
								...
								echo "<span style='float: left;'>".$routerow['arrival'] ." -> ".$routerow['departure']."</span>";
								echo "<span style='float:right;'>".$routerow['amount']."</span>";		
								echo "</div>";
								echo "<div class='row time'>";
								echo "<span style='float: left;'>". $businformationrow['busname']."</span>";
								echo "<span style='float: right;'><button class='btn btn-default seatbutton'>View Seats</button></span>";
								echo "		</div>";
								echo "		<div class='row time'>";
								echo "		<span style='float: left;'>".$businformationrow['bus_type']."</span>
											<span style='float: right;'><a href='#'>Boarding Details</a></span>
										</div>
									</div>
								</div>";
								}
						...
						else
						{
							...
							if($businforesult->num_rows===1)
							{
								...
								echo "</div>";
								echo "<div class='row time'>";
								echo "<span style='float: left;'>". $businforow['busname']."</span>";
								echo "<span style='float: right;'><button class='btn btn-default seatbutton'>View Seats</button></span>";
								echo "		</div>";
								echo "		<div class='row time'>";
								echo "		<span style='float: left;'>".$businforow['bus_type']."</span>
											<span style='float: right;'><a href='#'>Boarding Details</a></span>
										</div>
									</div>
								</div>";
